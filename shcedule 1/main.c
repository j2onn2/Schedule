...
int main(int argc, char *argv[]) {
	...
	fp = fopen("schedule.dat", "r")	;	//읽기모드로 schedule 파일 염  
	...
	{	
		fscanf(fp, "%s %s %d %d %d", name, place, &type, &month, &day)	; 	//fscanf를 이용하여 파일에서 받아옴  
		
		//fill code here -- generate genSchedInfo structure by genSchedInfo function
		
		sched_genSchedInfo(name, place, type, month, day)	;	// 받아온 변수들을 함수 sched_genSchedInfo 에 써줌 
